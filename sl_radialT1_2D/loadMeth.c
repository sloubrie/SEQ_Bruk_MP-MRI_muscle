/****************************************************************
 *
 * $Source: /pv/CvsTree/pv/gen/src/prg/methods/UTE/loadMeth.c,v $
 *
...
static const char resid[] = "$Id: loadMeth.c,v 1.3 2011/05/04 10:54:35 wemch Exp $ (C) 2002-2010 Bruker BioSpin MRI GmbH";
...
{
  DB_MSG(( "-->UTE:loadMeth( %s )", className ));
